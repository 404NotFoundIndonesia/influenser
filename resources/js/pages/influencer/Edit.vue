...
const addFromCreatorDB = () => {
    ...
    router.post(
        route('influencer.kol.import', props.item.id),
        {
            platform: importPlatform.value,
            ...
            <div class="grid gap-6 md:grid-cols-3">
                ...
                <div>
                    <template v-if="item.profile_picture_path && !editPhoto">
                        <div class="rounded-border border-surface flex flex-col items-center gap-2 rounded border">
                            <div class="flex w-full flex-1 items-center justify-end p-[1.125rem]">
                            ...
                            <div class="flex flex-col gap-8 pt-4">
                                ...
                                <div v-if="form.photo">
                                    <div class="rounded-border border-surface flex flex-col items-center gap-2 rounded border p-8">
                                        ...
                                        <span class="max-w-60 overflow-hidden text-ellipsis whitespace-nowrap text-sm font-semibold">{{
                                            form.photo?.name
                                        }}</span>
